...
/**
  ...
  @Example
    ...
    // Read RB10
    postValue = SYNC_GetValue();
    </code>

*/
#define SYNC_GetValue()         _RB10
/**
  @Summary
  ...
  @Example
    ...
    SYNC_SetDigitalInput();
    </code>

*/
#define SYNC_SetDigitalInput()  _TRISB10 = 1
/**
  @Summary
  ...
  @Example
    ...
    SYNC_SetDigitalOutput();
    </code>

*/
#define SYNC_SetDigitalOutput() _TRISB10 = 0
/**
  @Summary
...
/**
  ...
  @Example
    ...
    // Read RB11
    postValue = LDAC_GetValue();
    </code>

*/
#define LDAC_GetValue()         _RB11
/**
  @Summary
  ...
  @Example
    ...
    LDAC_SetDigitalInput();
    </code>

*/
#define LDAC_SetDigitalInput()  _TRISB11 = 1
/**
  @Summary
  ...
  @Example
    ...
    LDAC_SetDigitalOutput();
    </code>

*/
#define LDAC_SetDigitalOutput() _TRISB11 = 0
...
/**
  @Summary
    Configures the pin settings of the dsPIC33EP256GP502
    The peripheral pin select, PPS, configuration is also handled by this manager.
